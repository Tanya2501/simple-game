...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pixi__ = __webpack_require__(/*! pixi */ 88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_pixi___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_pixi__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_p2__ = __webpack_require__(/*! p2 */ 89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_p2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_p2__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_phaser__ = __webpack_require__(/*! phaser */ 24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__scss_main_scss__ = __webpack_require__(/*! ./scss/main.scss */ 317);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__states_Boot__ = __webpack_require__(/*! ./states/Boot */ 122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__states_Preload__ = __webpack_require__(/*! ./states/Preload */ 129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__states_Play__ = __webpack_require__(/*! ./states/Play */ 128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__states_Menu__ = __webpack_require__(/*! ./states/Menu */ 127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__states_Help__ = __webpack_require__(/*! ./states/Help */ 124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__states_Loss__ = __webpack_require__(/*! ./states/Loss */ 126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__config__ = __webpack_require__(/*! ./config */ 46);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
    constructor() {
        super(window.innerWidth, window.innerHeight, __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.CANVAS, 'content', null);

        this.state.add('Boot', __WEBPACK_IMPORTED_MODULE_4__states_Boot__["a" /* default */], false);
        this.state.add('Preload', __WEBPACK_IMPORTED_MODULE_5__states_Preload__["a" /* default */], false);
        this.state.add('Menu', __WEBPACK_IMPORTED_MODULE_7__states_Menu__["a" /* default */], false);
        this.state.add('Play', __WEBPACK_IMPORTED_MODULE_6__states_Play__["a" /* default */], false);
        this.state.add('Help', __WEBPACK_IMPORTED_MODULE_8__states_Help__["a" /* default */], false);
        this.state.add('Loss', __WEBPACK_IMPORTED_MODULE_9__states_Loss__["a" /* default */], false);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_webfontloader__ = __webpack_require__(/*! webfontloader */ 90);
...
/* harmony default export */ __webpack_exports__["a"] = (class {
    addMoreZombie() {
        ...
        this.physics.enable(this.zombie, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Physics.ARCADE);
    ...
    addMoreMonkey() {
        ...
        this.physics.enable(this.monkey, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Physics.ARCADE);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config__ = __webpack_require__(/*! ../config */ 46);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    create() {
        ...
        this.add.text(worldCenterX - 120, 150, 'Arrow keys (LEFT, RIGHT, UP) -\n Move, jump and shoot', __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].textStyle);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config__ = __webpack_require__(/*! ../config */ 46);
...
/* harmony default export */ __webpack_exports__["a"] = (class {
    ...
    hitPlayer(player) {
        player.kill();
        if (localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].localStorageName) === null) {
            localStorage.setItem(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].localStorageName, this.scores);
        } else if (this.scores > localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].localStorageName)) {
            localStorage.setItem(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].localStorageName, this.scores);
        }
        localStorage.setItem(__WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].localStorageLastScore, this.scores);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    create() {
        const worldCenterX = this.world.centerX;
        const highScore = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].localStorageName);
        const lastScore = localStorage.getItem(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].localStorageLastScore);

        const background = this.add.sprite(this.world.centerX - 150, 50, 'menu');
        background.scale.setTo(0.5, 0.5);

        this.add.text(worldCenterX - 120, 150, `Best score: ${highScore}`, __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].textStyle);
        this.add.text(worldCenterX - 120, 190, `Last player score: ${lastScore}`, __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].textStyle);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Enemy__ = __webpack_require__(/*! ./Enemy */ 123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Hit__ = __webpack_require__(/*! ./Hit */ 125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__config__ = __webpack_require__(/*! ../config */ 46);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    create() {
        ...
        const enemies = new __WEBPACK_IMPORTED_MODULE_1__Enemy__["a" /* default */]();
        ...
        this.killText = this.add.text(20, 20, '', __WEBPACK_IMPORTED_MODULE_3__config__["a" /* default */].textStylePlay);
        this.scoreText = this.add.text(20, 40, '', __WEBPACK_IMPORTED_MODULE_3__config__["a" /* default */].textStylePlay);
        this.monkeyText = this.add.text(20, 60, '', __WEBPACK_IMPORTED_MODULE_3__config__["a" /* default */].textStylePlay);
    ...
    update() {
        ...
        const hit = new __WEBPACK_IMPORTED_MODULE_2__Hit__["a" /* default */]();
    ...
    keyPress() {
        ...
        switch (true) {
            case this.cursors.left.isDown:
                ...
                this.physics.enable(lazer, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Physics.ARCADE);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
    ...
    create() {
        // create text
        const gameName = this.add.text(this.world.centerX, this.world.centerY - 35, 'monkey war', {
            font: '50px Bangers',
            fill: '#ffffff',
            align: 'center'
        });
        const teamDescription = this.add.text(this.world.centerX, this.world.centerY, 'created by green team', {
            font: '30px Bangers',
            fill: '#2d9e19',
            align: 'center'
        });
        ...
        this.add.tween(gameName).to({ alpha: 1 }, 2000, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Linear.None, true, 0, 0, true);

        this.add.tween(teamDescription).to({ alpha: 1 }, 2000, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Linear.None, true, 0, 0, true).onComplete.add(() => {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 50), __webpack_require__(/*! ./../process/browser.js */ 119)))
...
module.exports = __webpack_require__(/*! /Users/anton/Desktop/teamgreen-game-team/src/main.js */120);
